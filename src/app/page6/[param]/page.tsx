...
export default async function Page6({ params }: { params: { param: string } }) {
  const userData = await getUserData(params.param);
    ...
    return (
      <div className="max-w-3xl mx-auto p-6">
        ...
        <p className="text-lg text-gray-700 text-center">
          No user found with ID: <span className="font-bold text-red-500">{params.param}</span>.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 text-center">Página 6 - Static runtime</h1>
      ...
      <div className="p-6 bg-gray-100 border border-gray-200 rounded-lg shadow-sm">
        ...
        <ul className="mt-4 space-y-2">
          ...
          <li>
            <strong>Company:</strong> {userData.company.name} - {userData.company.catchPhrase}
          </li>
          <li>
